      ...
      <div className="container mx-auto pt-16 pb-8 px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-600 mb-6 py-2">
          ...
          <div>
            <h4 className="font-medium text-lg text-gray-900 mb-4">About Us</h4>
            <ul className="space-y-2 text-gray-600">
              <li><a href="/about" className="hover:text-primary transition-colors">Our Story</a></li>
              {/* <li><a href="/partner" className="hover:text-primary transition-colors">Become A Partner</a></li> */}
              <li><a href="/catalogues" className="hover:text-primary transition-colors">Catalogue</a></li>
            </ul>
          </div>
        </div>
